...
- Опционально пользователь может добавить чёрный список слов, по которому заказы должны исключаться, даже если присутствуют слова белого списка
- Опционально пользователь может добавить VIP-список слов, по которому заказы должны приходить вне зависимости от того, есть слова в чёрном списке или нет.
